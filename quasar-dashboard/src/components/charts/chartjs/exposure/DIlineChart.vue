...
<div>
    <q-card>
      <q-card-section>
        <Line chart-id="DI" :chart-data="chartData" :chartOptions="chartOptions" height="300"></Line>
      </q-card-section>
...
onMounted(()=>{
  ...
  chartData.datasets[0].data = DIData
  ...
  const baseline = Number(sortedBaselines[0].DI)

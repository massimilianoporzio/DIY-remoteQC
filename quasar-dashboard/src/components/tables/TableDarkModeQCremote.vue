...
<!--    </q-card-section>-->
    ...
    <q-card-section class="q-pa-none">
      <q-table dark  :rows="data" row-key="name" selection="single" :columns="columns"  @selection="onRowClick">
  ...
  setup(props,context) {
    ...
    return {
      ...
      onRowClick (evt, row) {
        ...
        context.emit("rowSelected",row)
        // console.log("EMIT ROW: ",selectedRow.value)
      },
